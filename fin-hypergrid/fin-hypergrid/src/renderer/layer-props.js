...
function assignProps(cellEvent) {
    ...
    assignments = new Array(propLayers.length + 1 - i);
    assignments[0] = Object.create(base);
    for (let assIndex = 1; i < propLayers.length; ++i, ++assIndex) {
        assignments[assIndex] = propClassGet[propLayers[i]](cellEvent);
    }
