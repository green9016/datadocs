...
var mixin = {
    ...
    fireSyntheticApiDestroyCalled: function(total) {
        return dispatchGridEvent.call(this, 'fin-api-destroy-called', { total: total });
    },
    ...
    fireRequestHideCellEdit: function() {
        return dispatchGridEvent.call(this, 'fin-request-hide-cell-edit', true, {}, {});
    },
    ...
    fireAfterHeaderCellEdit: function(cellEvent, oldValue, newValue, control) {
        return dispatchGridEvent.call(this, 'fin-after-header-cell-edit', {
            newValue: newValue,
            oldValue: oldValue,
            input: control
        }, cellEvent);
    ...
    fireFunctionContextMenu: function(inputControl, keyEvent) {
        return dispatchGridEvent.call(this, 'fin-function-context-menu', {
            input: inputControl,
            keyEvent: keyEvent,
            //char: this.canvas.getKeyChar(keyEvent),
            //legacyChar: keyEvent.legacyKey // decorated by getKeyChar
    ...
    delegateCanvasEvents: function() {
        ...
        this.addInternalEventListener('fin-canvas-mousedown', function(e) {
            ...
            // we prevent to stop editing if formulaMode
            if (!grid.cellEditor || grid.cellEditor.canStopEditing()) {
        ...
        this.addInternalEventListener('fin-canvas-keydown', function(e) {
            console.log('fin-canvas-keydown======', grid.properties.readOnly);
            if (grid.properties.readOnly) {
                return;
            }
        ...
        document.body.addEventListener('copy', function(evt) {
            if (grid.canvas.hasPerspxFormFocus()){
              // Not allow to perform copy from grid
              return;
            }

            if (grid.behavior.dataModel.isFetchCopyData()) {
                grid.behavior.dataModel.setFetchCopyData(false);
                grid.checkClipboardCopy(evt);
            } else {
                grid.getClipboardCopyValue(evt);
            }
        }, false);
        ...
        this.addInternalEventListener('fin-after-cell-edit', function (e) {
            console.log('========2======fin-after-cell-edit');
        ...
        this.addInternalEventListener('fin-function-context-menu', function (e) {
            console.log('fin-function-context-menu--------', e);

            // ! TODO
            // check keychar is arrow button

            // check keychar is tab button

            // check keychar is enter button

            // editor type to colorful

            //  parse input string and match function
            // show context menu
        });
