 ...
 * @extends CellEditor
 */
var Textcolorization = CellEditor.extend('Textcolorization', {

    template: '<pre style=""><code class="language-json" style=""><div lang="{{locale}}" class="hypergrid-textcolorization" style="{{style}}">',
...
module.exports = Textcolorization;
