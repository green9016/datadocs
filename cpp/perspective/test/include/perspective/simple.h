...
// Duration specializations
template <>
const t_tscalar test_traits<t_duration>::zero = mktscalar(t_duration());
template <>
const t_tscalar test_traits<t_duration>::v1 = mktscalar(t_duration(0, 0, 1));
template <>
const t_tscalar test_traits<t_duration>::v2 = mktscalar(t_duration(0, 0, 1));
...
template <>
const t_tscalar test_traits<t_decimal>::zero = mktscalar(t_decimal("0"));
template <>
const t_tscalar test_traits<t_decimal>::v1 = mktscalar(t_decimal("1"));
template <>
const t_tscalar test_traits<t_decimal>::v2 = mktscalar(t_decimal("2"));
...
typedef test_traits<t_duration> tr_duration;
typedef test_traits<t_time> tr_time;
typedef test_traits<t_decimal> tr_decimal;
