...
enum t_status : std::uint8_t { STATUS_INVALID, STATUS_ERROR, STATUS_EMPTY, STATUS_VALID, STATUS_CLEAR, STATUS_WARNING };
...
inline bool
is_dtype_list(t_dtype t) {
    return t == t_dtype::DTYPE_LIST_STR || t == t_dtype::DTYPE_LIST_INT64
        || t == t_dtype::DTYPE_LIST_FLOAT64 || t == t_dtype::DTYPE_LIST_BOOL
        || t == t_dtype::DTYPE_LIST_TIME || t == t_dtype::DTYPE_LIST_DATE
