...
namespace binding {
    ...
    // Time parsing
    t_time jsdate_to_t_time(emscripten::val time);
    ...
    emscripten::val scalar_to_val(
        const t_tscalar& scalar, bool cast_double = false, bool cast_string = false, bool exact_type = false,
        bool full_value = true, bool include_error = false);
