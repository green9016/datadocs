...
const double EPSILON = double(1)/double(SECS_PER_DAY);
const std::string FULL_MONTHS[12] = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Sep"};
const std::string TIME_PERIODS[2] = {"AM", "PM"};
const std::string WEEK_DAYS[7] = {"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"};
...
double to_gmtime(std::int32_t year, std::int32_t month, std::int32_t day,
    std::int32_t hour, std::int32_t min, std::int32_t sec);
std::int32_t quarter_of_year(std::int32_t month);
std::int32_t day_of_year(std::int32_t year, std::int32_t month, std::int32_t day);
std::int32_t day_of_weed(std::int32_t year, std::int32_t month, std::int32_t day);
std::int32_t week_of_year(std::int32_t year, std::int32_t month, std::int32_t day);
...
public:
    ...
    t_time();
    explicit t_time(double raw_val);
    ...
    std::int32_t gmtime(struct tm& out, double secs, std::int32_t offset) const;
